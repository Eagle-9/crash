...
# source files
SOURCES = src/main.cc src/shell.cc src/builtin/cd.cc src/builtin/exit.cc src/builtin/history.cc src/builtin/alias.cc src/builtin/unalias.cc src/builtin/set.cc src/builtin/help.cc src/builtin/source.cc
